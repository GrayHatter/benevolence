pub const rules: []const Detection = &[_]Detection{
    ...
    .{
        ...
        .prefix = &[_]Detection{
            ...
            .{ .hit = "GET /.env HTTP/" },
            .{ .hit = "GET /app/.env HTTP/" },
            .{ .hit = "GET /dev/.env HTTP/" },
            .{ .hit = "GET /docker/.env HTTP/" },
            ...
            .{ .hit = "GET /phpinfo.php HTTP/1.1\" 40" },
            ...
            .{ .hit = "GET /.well-known/.well-known/ HTTP/" },
            .{ .hit = "GET /.wp-cli/autoload_classmap.php HTTP/1" },
            .{ .hit = "GET /1.php HTTP/1.1\" 404" },
            .{ .hit = "GET /admin.php HTTP/1.1\" 404" },
            .{ .hit = "GET /autoload_classmap.php HTTP/1" },
            .{ .hit = "GET /wp-admin/css/colors/autoload_classmap.php HTTP/1" },
        },
    },
